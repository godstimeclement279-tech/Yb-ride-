// Firebase config (driver app). Replace PASTE_… with values from
// Firebase Console → Project Settings → Your apps → Web app.
// Driver app uses the JS SDK via Expo (same approach as passenger).
...
export const FIREBASE_CONFIG: FirebaseConfig = {
  ...
  appId: '1:191199341592:web:e9d64e60bdf9652bbc676d',
